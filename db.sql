...
CONSTRAINT FK_clients_groups_clients FOREIGN KEY (username) REFERENCES clients(username)
);
...
CONSTRAINT FK_clients_friends_clients FOREIGN KEY (username) REFERENCES clients(username)
);
